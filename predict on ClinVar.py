...
def predict_ClinVar_order3(gpu_id=1, type='Insertion'):
    ...
    #transformer = train_model.load_model(device, model_dir='/content/pegRNA_Model_Merged_saved.order3_decoder.pt',
    #                                     model_name='pegRNA_Model_Merged_saved.order3_decoder.pt')  # load model
    transformer =train_model.load_model(device, model_dir='/content/',
                                         model_name='pegRNA_Model_Merged_saved.order3_decoder.pt')  # load model
